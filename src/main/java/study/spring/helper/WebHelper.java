...
public class WebHelper {
	 ...
	 * Spring이 제공하는 ServletReqeustAttributes 객체를 통해서 request, response 객체를
	 * 직접 생성할 수 있다.
	 */
	public void init() {
		/** JSP 내장객체를 담고있는 Spring의  객체를 통해서 내장객체 획득하기*/
	...
	/**
	 * 문자열에 포함된 HTML태그와 줄바꿈 문자를HTML특수문자로 형태로 변환
	 * @param content
	 * @return String*/
